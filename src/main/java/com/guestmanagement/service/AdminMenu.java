...
// 3. Object Creation
// 4. Polymorphism (using interface references)

public class AdminMenu {

    // Static variable - stores current logged-in admin
    private static AdminDB currentAdmin = null;
    ...
    public static void show() {
        ...
        while (choice != 0) {
            ...
            // Using overloaded readInt with range (Polymorphism)
            choice = Input.readInt("Enter choice: ", 0, 1);
    ...
    static void adminMenu() {
        ...
        while (choice != 0) {
            ...
            choice = Input.readInt("Enter choice: ", 0, 7);
    ...
    static void manageProperties() {
        ...
        while (choice != 0) {
            ...
            System.out.println("\uD83D\uDEAA 0. Back");
            choice = Input.readInt("Enter choice: ", 0, 4);
    ...
    static void updateProperty() {
        ...
        try {
            ...
            if (!location.isEmpty()) p.setLocation(location);
            if (!owner.isEmpty()) p.setOwner(owner);
    ...
    static void addRoom() {
        try {
            ...
            double rent = Input.readDouble("Rent       : ", 0); // Using overloaded method
    ...
    static void updateRoom() {
        ...
        try {
            ...
            // Using setters (Encapsulation)
            if (!roomNo.isEmpty()) r.setRoomNo(roomNo);
            if (!type.isEmpty()) r.setType(type);
            if (!rentStr.isEmpty()) r.setRent(Double.parseDouble(rentStr));
            if (!availStr.isEmpty()) r.setAvailable(Boolean.parseBoolean(availStr));

            RoomDB.update(r);
            System.out.println("  \u2705 Room updated successfully!");
        } catch (NumberFormatException e) {
            System.out.println("  \u26A0 Invalid number format for rent!");
        } catch (Exception e) {
